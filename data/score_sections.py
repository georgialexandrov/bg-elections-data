...
HOSPITAL_KEYWORDS = ['болниц', 'умбал', 'мбал', 'сбал', 'мобал', 'клиник', 'дкц',
                     'диспансер', 'хоспис', 'дом за стари хора', 'дом за възрастни', 'сбр ']
...
from validators import validate_protocols  # per-election protocol validators
